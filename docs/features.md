...
| 首页年份分区 | 首页按 `album_year` 自动分区，并支持年份导航定位 | 完成 |
...
| 首页年份分组 | 首页按用户选择的 `album_year` 分组展示相册 | 完成 |
| 详情年份分组 | 相册详情按 event_time/created_at 年份分组展示媒体 | 完成 |
| 年份书签导航 | 首页和详情页支持年份导航，点击跳转对应年份 | 完成 |
